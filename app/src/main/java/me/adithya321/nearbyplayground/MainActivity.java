...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    /**
     * Build the message that is going to be published. This contains the message and a
     * UUID.
     */
    private void getPubMessage() {
        String message = mMessageEditText.getText().toString();
        if (TextUtils.isEmpty(message)) message = Build.MODEL;
